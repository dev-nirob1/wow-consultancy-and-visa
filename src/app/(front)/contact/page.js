...
const ContactPage = () => {
  return (
    <>
      <PageHero
        title="Contact Us"
        description="Have questions about studying in South Korea? Reach out and our counselors will guide you."
      />
          ...
          <div className="grid lg:grid-cols-2 gap-5">
            <div>
              ...
              <p className="mt-4 text-lg">
                Whether you&apos;re curious about university admissions, visa
                processing, or our premium services, we&apos;re here to help.
              </p>
